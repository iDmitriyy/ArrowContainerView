...
class ViewController: UIViewController {
    ...
    private func setupArrowTest() {
        ...
        let bottomTargetCenter = bottomTargetView.centerXAnchor.constraint(equalTo: self.view.centerXAnchor)
        ...
        do {
            ...
            NSLayoutConstraint.activate([
                bottomTargetView.topAnchor.constraint(equalTo: arrow.bottomAnchor, constant: 2),
                bottomTargetCenter,
        ...
        do {
            ...
            let targetCenter = topTargetView.centerXAnchor.constraint(equalTo: self.view.centerXAnchor, constant: 20)
        ...
        arrow.setArrowCenteredTo(anchor: .toXCenterOf(targetView: topTargetView))
        arrow.view.setTitle("dsfsdfdsfsfs", for: .normal)
        arrow.backgroundColor = UIColor.lightGray
    ...
    func showArrowViewsTest() {
        let targetTopArrowViewTest = makeArrowView(text: "Стрелка смотрит розовый квадратик сверху")
        let topTargetTest = makeTarget(withLeading: -30)
    }
...
//        }
        ...
        do {
            ...
            for subView in all {
                ...
                constraints.append(contentsOf: [
                    subView.leadingAnchor.constraint(equalTo: superView.safeAreaLayoutGuide.leadingAnchor),
                    superView.trailingAnchor.constraint(equalTo: subView.safeAreaLayoutGuide.trailingAnchor),
    ...
    func makeTarget(withLeading leading: CGFloat) -> (target: UIView, container: UIView) {
        ...
        do {
            ...
            targetViewContainer.backgroundColor = UIColor.cyan
